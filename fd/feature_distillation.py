...
def FD_jpeg_encode(input_matrix):
    ...
    input_matrix = tf.transpose(input_matrix, [0, 2, 3, 1])
    input_matrix=tf.image.resize_images(input_matrix,(304,304),method=0)
    ...
    output3=tf.image.resize_images(output3,(299,299),method=0)
    output3 = tf.transpose(output3, [0,3,1,2])
    return output3